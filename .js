...
function update()
{
    ...
    */
    ...
    To find the minimum age value amongst the family members, we need to use the Math, and the mi function together and to display the maximum age, we need print the value. Thus make use of console.
